Error: Command failed: GIT_SSH=/mnt/floobits/id_rsa_floobot.sh git clone --depth 1 --recursive 'https://github.com/FireWAV3/SE_Praktikum_Xcom.git' --branch 'master' /mnt/floobits/repos/room_943394
